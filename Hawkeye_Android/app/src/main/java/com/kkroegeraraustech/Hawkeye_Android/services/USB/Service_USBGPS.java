...
//import com.kkroegeraraustech.Hawkeye_Android.services.USB.usbserial.CDCSerialDevice;
//import com.kkroegeraraustech.Hawkeye_Android.services.USB.usbserial.UsbSerialDevice;
//import com.kkroegeraraustech.Hawkeye_Android.services.USB.usbserial.UsbSerialInterface;
 ...
 */
public class Service_USBGPS extends Service{

    public Service_USBGPS(){

    }

    public class LocalBinder extends Binder {
        public Service_USBGPS getService(){
            return Service_USBGPS.this;
        }
    }


    UpdateUSBGPSListener mOnServiceListener_Remote;

    public void setOnServiceListener(UpdateUSBGPSListener serviceListener) {
        mOnServiceListener_Remote = serviceListener;
    }

    public interface UpdateUSBGPSListener {
        public void onUpdateGPS(Location locationUpdate);
    }


    /**
     * These variables handle the NMEAParser Class and store the necessary string from the
     * port for data manipulation.
     */
    ...
    public static final int MESSAGE_RAW = 0;
...
//                        mOnServiceListener_Remote.onUpdateGPS(tempLocation);
//                    }
//                }
    ...
    public void onDestroy() {
        super.onDestroy();
        Service_USBGPS.SERVICE_CONNECTED = false;
    }
