  ...
  getMainView() {
    return (
      <View
        ...
        key="main"
        ref={c => this.main = c}
        style={{height: this.getHeight(), width: this.getMainWidth(), flex:1, marginTop:0, backgroundColor: 'transparent'}}
        >
        {this.props.children}
  ...
  getDrawerView() {
    return (
      <View
        ...
        key="drawer"
        ref={c => this.drawer = c}
        style={[this.stylesheet.drawer, {height: this.getHeight(), width: this.getDrawerWidth(), marginTop:0}]}
      >
        {this.props.content}
      </View>
    )
  ...
  render() {
    ...
    return (
      <View
        ...
        style={[this.stylesheet.container, {backgroundColor: 'transparent'}]}
        >
        {first}
        {second}
      </View>
